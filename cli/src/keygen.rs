...
fn keygen_new(
    ...
    // Convert to solana Keypair (64 bytes: 32 secret + 32 public)
    let verifying_key_bytes = signing_key.verifying_key().to_bytes();
    let mut keypair_bytes = [0u8; 64];
    keypair_bytes[..32].copy_from_slice(&secret_key_bytes);
    keypair_bytes[32..].copy_from_slice(&verifying_key_bytes);
...
mod tests {
    ...
    fn test_keypair_from_seed_consistency() {
        ...
        let signing_key1 = SigningKey::from_bytes(&secret_key_bytes1);
        let verifying_key_bytes1 = signing_key1.verifying_key().to_bytes();
        let mut keypair_bytes1 = [0u8; 64];
        keypair_bytes1[..32].copy_from_slice(&secret_key_bytes1);
        keypair_bytes1[32..].copy_from_slice(&verifying_key_bytes1);
        let keypair1 = Keypair::from_bytes(&keypair_bytes1).unwrap();
        ...
        let signing_key2 = SigningKey::from_bytes(&secret_key_bytes2);
        let verifying_key_bytes2 = signing_key2.verifying_key().to_bytes();
        let mut keypair_bytes2 = [0u8; 64];
        keypair_bytes2[..32].copy_from_slice(&secret_key_bytes2);
        keypair_bytes2[32..].copy_from_slice(&verifying_key_bytes2);
        let keypair2 = Keypair::from_bytes(&keypair_bytes2).unwrap();
    ...
    fn test_keypair_with_passphrase() {
        ...
        let signing_key_no_pass = SigningKey::from_bytes(&secret_key_bytes_no_pass);
        let verifying_key_bytes_no_pass = signing_key_no_pass.verifying_key().to_bytes();
        let mut keypair_bytes_no_pass = [0u8; 64];
        keypair_bytes_no_pass[..32].copy_from_slice(&secret_key_bytes_no_pass);
        keypair_bytes_no_pass[32..].copy_from_slice(&verifying_key_bytes_no_pass);
        let keypair_no_pass = Keypair::from_bytes(&keypair_bytes_no_pass).unwrap();
        ...
        let signing_key_with_pass = SigningKey::from_bytes(&secret_key_bytes_with_pass);
        let verifying_key_bytes_with_pass = signing_key_with_pass.verifying_key().to_bytes();
        let mut keypair_bytes_with_pass = [0u8; 64];
        keypair_bytes_with_pass[..32].copy_from_slice(&secret_key_bytes_with_pass);
        keypair_bytes_with_pass[32..].copy_from_slice(&verifying_key_bytes_with_pass);
        let keypair_with_pass = Keypair::from_bytes(&keypair_bytes_with_pass).unwrap();
