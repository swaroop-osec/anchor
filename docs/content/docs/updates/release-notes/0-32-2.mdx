...
`0.32.2` adds TypeScript client support for parsing Solana transaction version 1
...
[CHANGELOG](https://github.com/otter-sec/anchor/blob/v0.32.2/CHANGELOG.md#0322---2026-09-12).
