...
`0.31.2` adds TypeScript client support for parsing Solana transaction version 1
...
[CHANGELOG](https://github.com/otter-sec/anchor/blob/v0.31.2/CHANGELOG.md#0312---2026-09-12).
