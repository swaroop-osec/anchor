...
| accountEmptyInit1           | 4,851         | 🟢 **-232 (4.56%)**    |
...
| accountEmptyInit8           | 31,853        | 🟢 **-2,870 (8.27%)**  |
| accountEmpty8               | 3,548         | 🔴 **+385 (12.17%)**   |
| accountSizedInit1           | 4,955         | 🟢 **-237 (4.56%)**    |
...
| boxedAccountEmptyInit8      | 32,086        | 🟢 **-2,867 (8.20%)**  |
| boxedAccountEmpty8          | 3,801         | 🔴 **+400 (11.76%)**   |
| boxedAccountSizedInit1      | 5,039         | 🟢 **-232 (4.40%)**    |
...
| boxedAccountSizedInit8      | 32,686        | 🟢 **-2,867 (8.06%)**  |
| boxedAccountSized8          | 4,007         | 🔴 **+379 (10.45%)**   |
| boxedAccountUnsizedInit1    | 5,138         | 🟢 **-233 (4.34%)**    |
...
| boxedAccountUnsizedInit8    | 33,310        | 🟢 **-2,875 (7.95%)**  |
